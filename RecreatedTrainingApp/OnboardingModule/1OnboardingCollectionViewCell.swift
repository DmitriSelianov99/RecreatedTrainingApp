...
class OnboardingCollectionViewCell1: UICollectionViewCell {
    ...
    private let topLabel = UILabel(text: "Default", font: .robotoBold24()!, textColor: .specialGreen)
    private let bottomLabel = UILabel(text: "Default", font: .robotoMedium16()!, textColor: .white)
    ...
    public func setConfigure(model: onboardingStruct){
...
extension OnboardingCollectionViewCell1 {
